...
export function expectSortedDesc(actual, message = "Comparing actual list with descending-sorted: ") {
...
export function expectSameMembers(actual, expected, message = "Comparing lists after sorting (order ignored)") {
